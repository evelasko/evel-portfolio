  ...
  <>
    ...
    <Divider speed={0.1} offset={offset} factor={2}>
      <UpDown>
        ...
        <SVG icon="upDown" width={8} fill={colors.teal} left="55%" top="10%" />
      ...
      <SVG icon="box" width={12} fill={colors.yellow} left="29%" top="16%" />
      <SVG icon="hexa" width={16} stroke={colors.red} left="50%" top="2%" />
